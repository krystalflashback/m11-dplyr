...
# Read in the data
setwd("~/Desktop/m11-dplyr/exercise-8")
...
at.least.5.won.biggest.derease <- filter(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014 > 5) %>%  
  filter(min(Pulitzer.Prize.Winners.and.Finalists..2004.2014) ==
           Pulitzer.Prize.Winners.and.Finalist..2004.2014) %>% 
  select(Newspaper)
